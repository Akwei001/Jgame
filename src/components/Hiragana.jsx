  ...
  return (
    ...
    <div className='min-h-screen text-center text-white bg-slate-100'>
      ...
      <div className='grid grid-cols-5 gap-4 m-10'>
        {htile.map((tile) => (
          <div key={tile.id}>
            <div className='text-6xl font-bold text-transparent shadow-lg bg-slate-200 rounded-xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 w-18 h-18'>
